(function () {
  function initTimelineInfiniteScroll() {
    var list = document.getElementById("timeline-list");
    if (!list) {
      return;
    }

    if (list._timelineScrollObserver) {
      list._timelineScrollObserver.disconnect();
      list._timelineScrollObserver = null;
    }
    ...
    list._timelineScrollObserver = observer;
  }

  window.initTimelineInfiniteScroll = initTimelineInfiniteScroll;
  initTimelineInfiniteScroll();
})();
