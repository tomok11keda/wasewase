(function () {
  ...
  var polling = false;
  var showSenderNames = area.dataset.showSenderNames === "1";
  ...
  function createMessageItem(msg) {
    ...
    if (showSenderNames && !msg.is_mine && msg.sender_name) {
      var sender = document.createElement("div");
      sender.className = "chat-row__sender";
      sender.textContent = msg.sender_name;
      main.appendChild(sender);
    }

    var bubbleWrap = document.createElement("div");
    bubbleWrap.className = "chat-row__bubble-wrap";
