...
def create_course_attendance_record_if_missing(apps, schema_editor):
    Model = apps.get_model("app", "CourseAttendanceRecord")
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            create_course_attendance_record_if_missing,
